    ...
    <DashboardLayout>
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 h-full flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between flex-none px-1">
          <div>
            <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent">Opportunity & Trading Desk</h1>
            <p className="text-xs text-muted-foreground mt-0.5">Real-time market access, acquisition targets, and statistical arbitrage.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 flex-none">
          ...
          <Card className="border-l-4 border-l-blue-500/50 bg-black/40 backdrop-blur-sm border-white/5">
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-1">
                <p className="text-xs font-medium text-zinc-400">Active Opportunities</p>
                <Activity className="h-3.5 w-3.5 text-blue-400" />
              </div>
              <div className="text-xl font-bold text-white">14</div>
              <p className="text-[10px] text-muted-foreground">Across 3 Asset Classes</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-purple-500/50 bg-black/40 backdrop-blur-sm border-white/5">
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-1">
                <p className="text-xs font-medium text-zinc-400">Model Win Rate</p>
          ...
          <Card className="border-l-4 border-l-amber-500/50 bg-black/40 backdrop-blur-sm border-white/5">
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-1">
                <p className="text-xs font-medium text-zinc-400">Capital At Risk</p>
                <AlertTriangle className="h-3.5 w-3.5 text-amber-400" />
              </div>
              <div className="text-xl font-bold text-amber-400">15%</div>
              <p className="text-[10px] text-muted-foreground">Optimal Deployment</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-hidden">
          ...
          <div className="lg:col-span-1 h-full min-h-0 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 pr-2">
            <Card className="flex flex-col bg-black/20 border-white/5 mb-6">
              <CardHeader className="py-3 flex-none border-b border-white/5">
                <CardTitle className="text-sm">Manual Order Entry</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
             ...
             {/* Live Positions - Moved to Left Column for better flow */}
             <Card className="flex flex-col bg-black/20 border-white/5">
          ...
          {/* Right Column: AI Opportunity Feed - Spans 2 Columns */}
          <div className="lg:col-span-2 h-full min-h-0 flex flex-col gap-4 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 pr-2">
            <OpportunityFeed />
          </div>
